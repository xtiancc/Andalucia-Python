...
incremento = int(input("Por favor, seleccione el incremento: "))
...
cursor = conexion.cursor()
sqlafectado = "select apellido, oficio, salario from emp where oficio=?"
cursor.execute(sqlafectado, (oficio))
